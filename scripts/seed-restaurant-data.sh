...
if docker compose ps 2>/dev/null | grep -q "backend.*Up"; then
    ...
    if [ $SEED_EXIT_CODE -eq 0 ]; then
        ...
        echo "═══════════════════════════════════════════════"
        echo -e "${YELLOW}Password for ALL users: password123${NC}"
        echo ""
        echo -e "${GREEN}1. ADMIN:${NC}           admin@restaurant.com"
        echo -e "${GREEN}2. OWNER:${NC}           owner@restaurant.com"
        echo -e "${GREEN}3. MANAGER:${NC}         manager@restaurant.com"
        echo -e "${GREEN}4. CASHIER:${NC}         cashier@restaurant.com"
        echo -e "${GREEN}5. WAITER:${NC}          waiter@restaurant.com"
        echo -e "${GREEN}6. KITCHEN STAFF:${NC}   kitchen@restaurant.com"
        echo -e "${GREEN}7. INVENTORY CLERK:${NC} inventory@restaurant.com"
        echo ""
